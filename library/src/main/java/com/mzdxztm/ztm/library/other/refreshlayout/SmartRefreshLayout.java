package com.mzdxztm.ztm.library.other.refreshlayout;
...
import com.mzdxztm.ztm.library.other.refreshlayout.api.DefaultRefreshFooterCreator;
import com.mzdxztm.ztm.library.other.refreshlayout.api.DefaultRefreshHeaderCreator;
import com.mzdxztm.ztm.library.other.refreshlayout.api.DefaultRefreshInitializer;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshContent;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshFooter;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshHeader;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshInternal;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshKernel;
import com.mzdxztm.ztm.library.other.refreshlayout.api.RefreshLayout;
import com.mzdxztm.ztm.library.other.refreshlayout.api.ScrollBoundaryDecider;
import com.mzdxztm.ztm.library.other.refreshlayout.constant.DimensionStatus;
import com.mzdxztm.ztm.library.other.refreshlayout.constant.RefreshState;
import com.mzdxztm.ztm.library.other.refreshlayout.constant.SpinnerStyle;
import com.mzdxztm.ztm.library.other.refreshlayout.footer.BallPulseFooter;
import com.mzdxztm.ztm.library.other.refreshlayout.header.BezierRadarHeader;
import com.mzdxztm.ztm.library.other.refreshlayout.impl.RefreshContentWrapper;
import com.mzdxztm.ztm.library.other.refreshlayout.impl.RefreshFooterWrapper;
import com.mzdxztm.ztm.library.other.refreshlayout.impl.RefreshHeaderWrapper;
import com.mzdxztm.ztm.library.other.refreshlayout.listener.OnLoadMoreListener;
import com.mzdxztm.ztm.library.other.refreshlayout.listener.OnMultiPurposeListener;
import com.mzdxztm.ztm.library.other.refreshlayout.listener.OnRefreshListener;
import com.mzdxztm.ztm.library.other.refreshlayout.listener.OnRefreshLoadMoreListener;
import com.mzdxztm.ztm.library.other.refreshlayout.listener.OnStateChangedListener;
import com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil;
...
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.dp2px;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.fling;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.isContentView;
...
//    }
     ...
     * Recommended {@link com.mzdxztm.ztm.library.other.refreshlayout.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.mzdxztm.ztm.library.other.refreshlayout.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.mzdxztm.ztm.library.other.refreshlayout.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.mzdxztm.ztm.library.other.refreshlayout.impl.ScrollBoundaryDeciderAdapter}
