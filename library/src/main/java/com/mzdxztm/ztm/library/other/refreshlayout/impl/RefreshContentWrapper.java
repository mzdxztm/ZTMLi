...
import com.mzdxztm.ztm.library.other.refreshlayout.listener.CoordinatorLayoutListener;
import com.mzdxztm.ztm.library.other.refreshlayout.util.DesignUtil;
...
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.canScrollVertically;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.isContentView;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.isTransformedTouchPointInView;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.measureViewHeight;
import static com.mzdxztm.ztm.library.other.refreshlayout.util.SmartUtil.scrollListBy;
